            ...
            <div class="field">
              <div class="control">
                <div class="b-checkbox is-warning is-circular is-inline">
                  ...
                  <label for="terms">
                    <span class="content has-text-white">  I Accept and Read the <a class="has-text-warning" href="https://raw.githubusercontent.com/souvikmondal97/happy4geeks/dark-mode-0-1/CONTRIBUTING.md" target="_blank">Community Guidelines</a></span>
                  </label>
                </div>
              </div>
            </div>
            <div class="field">
              <div class="control">
                <div class="b-checkbox is-warning is-circular is-inline">
                  ...
                  <label for="code">
                    <span class="content has-text-white">  I Accept and Read the <a class="has-text-warning" href="https://github.com/souvikmondal97/happy4geeks/blob/dark-mode-0-1/CODE_OF_CONDUCT.md" target="_blank">Code of Conduct</a></span>
                  </label>
                </div>
              </div>
            </div>
